...
Revision ID: 7932bfe78a95
Revises: 
Create Date: 2026-01-22 17:57:18.864986
...
def upgrade() -> None:
    ...
    sa.Column('storage_tips_snapshot', sa.Text(), nullable=True),
    sa.Column('default_shelf_life_day_snapshot', sa.Integer(), nullable=True),
